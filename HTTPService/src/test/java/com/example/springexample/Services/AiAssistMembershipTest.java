...
class AiAssistMembershipTest {
    ...
    void memberReachesChatContext() {
        ...
        // готовый вердикт, а не собирать собственный поверх members(). Ассерт структурный
        // нарочно — обе версии ведут себя одинаково, и вернувшуюся копию политики поймать
        // по поведению нельзя; именно так дубль и дожил до отдельного тикета.
        Mockito.verify(membership).isMemberReactive(3L, "4");
    }
