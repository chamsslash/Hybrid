...
- [`docs/adr/`](adr/README.md) — архитектурные решения: что выбрали, что рассматривали и от
  чего отказались. Начато с [ADR-0001](adr/0001-full-spa-frontend.md) — фронт доводится до
  полного SPA (тикет j35).
